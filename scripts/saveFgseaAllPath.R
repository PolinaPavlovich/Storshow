...
saveFgsea(dds, examplePathways, "EntrezID", 
          resRDSdir,
          outdir, 
          fnPart = "allPath",
...
outTable <- data.frame(successMessage = 
                           paste0("saveFgseaAllPath is completed successfully.\n",
                                  "The output is in ", outdir))
write.table(outTable, file=file.path(workdir, "FGSEA/saveFgseaAllPath.tsv"),
